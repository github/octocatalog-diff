...
describe OctocatalogDiff::CatalogDiff::Cli do
  ...
  describe '#catalog_only' do
    context 'working catalog output to file' do
      before(:each) do
        ...
        d = double('OctocatalogDiff::CatalogDiff::Cli::Catalogs')
        allow(OctocatalogDiff::CatalogDiff::Cli::Catalogs).to receive(:new).and_return(d)
  ...
  describe '#bootstrap_then_exit' do
    ...
    it 'should fail and exit 1 if BootstrapError occurs' do
      d = double('OctocatalogDiff::CatalogDiff::Cli::Catalogs')
      allow(d).to receive(:bootstrap_then_exit).and_raise(OctocatalogDiff::CatalogDiff::Cli::Catalogs::BootstrapError, 'hello')
      logger, logger_str = OctocatalogDiff::Spec.setup_logger
      rc = OctocatalogDiff::CatalogDiff::Cli.bootstrap_then_exit(logger, d)
      expect(rc).to eq(1)
